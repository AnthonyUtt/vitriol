pub const QUAD_VERTEX_SHADER_SOURCE: &str = include_str!("./shaders/quad.vert.glsl");
pub const QUAD_FRAGMENT_SHADER_SOURCE: &str = include_str!("./shaders/quad.frag.glsl");
